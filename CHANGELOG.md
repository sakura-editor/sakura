...
- Beta3リリース用修正 [\#1117](https://github.com/sakura-editor/sakura/pull/1117) ([KENCHjp](https://github.com/KENCHjp))
...
- ベータ２リリース用ヘルプ修正 [\#1096](https://github.com/sakura-editor/sakura/pull/1096) ([KENCHjp](https://github.com/KENCHjp))
...
- Release/v2.4.0 beta prepare [\#1075](https://github.com/sakura-editor/sakura/pull/1075) ([KENCHjp](https://github.com/KENCHjp))
...
- .gitignore を Azure Pipelines の無視リストに追加する [\#924](https://github.com/sakura-editor/sakura/pull/924) ([m-tmatma](https://github.com/m-tmatma))
