...
struct CEditorProcessInitTest : public ::testing::Test
{
	...
	static void TearDownTestSuite() {
		...
		auto controlProcess = CProcessFactory().CreateInstance(fmt::format(LR"(-PROF="{}")", profileName));
		controlProcess->TerminateControlProcess();
	}
};
