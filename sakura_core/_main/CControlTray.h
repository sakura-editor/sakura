...
public:
	...
	*/
	...
	static bool OpenNewEditor2( //!< 新規編集ウィンドウの追加 ver 1
		HINSTANCE hInstance, HWND hWndParent, const EditInfo *pfi, bool bViewMode, bool sync = false,
...
protected:
	...
	BOOL TrayMessage(HWND hDlg, DWORD dwMessage, UINT uID, HICON hIcon,
					 const WCHAR *pszTip); /*!< タスクトレイのアイコンに関する処理 */
	...
	static INT_PTR CALLBACK ExitingDlgProc(
		/*!< 終了ダイアログ用プロシージャ */ // 2006.07.02 ryoji CControlProcess から移動
