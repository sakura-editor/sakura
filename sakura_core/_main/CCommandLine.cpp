            ...
            switch (CheckCommandLine(pszToken, &arg, &nArgLen))
            {
                ...
                case CMDLINEOPT_GOPT: //	GOPT
                    for (; *arg != '\0'; ++arg)
                    {
                        ...
                        {
                            case 'X':
                                m_gi.bGrepCurFolder = true;
                                break;
                            case 'U':
                                m_gi.bGrepStdout = true;
                                break;
                            case 'H':
                                m_gi.bGrepHeader = false;
                                break;
                            case 'S':
                                // サブフォルダからも検索する
                            ...
                            case '3':
                                ...
                                break;
                            case 'F':
                                m_gi.bGrepOutputFileOnly = true;
                                break;
                            case 'B':
                                m_gi.bGrepOutputBaseFolder = true;
                                break;
                            case 'D':
                                m_gi.bGrepSeparateFolder = true;
                                break;
                            case 'C':
                                m_gi.bGrepPaste = true;
                                break;
                            case 'O':
                                m_gi.bGrepBackup = true;
                                break;
                        }
                    }
                    break;
                ...
                case CMDLINEOPT_GCODE:
                    m_gi.nGrepCharSet = (ECodeType)AtoiOptionInt(arg);
                    break;
