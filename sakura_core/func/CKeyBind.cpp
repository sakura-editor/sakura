...
#define _COPYWITHLINENUM	F_COPYLINESWITHLINENUMBER
	...
	//		0,		1,		 2(000), 3(001),4(010),	5(011),		6(100),	7(101),		8(110),		9(111)
		...
		{ 0,_T("ホイールアップ"),		{ F_WHELLUP,		F_WHELLUP,			F_SETFONTSIZEUP,		F_WHELLUP,			F_WHELLUP,				F_WHELLUP,			F_WHELLUP,				F_WHELLUP }, },
		{ 0,_T("ホイールダウン"),		{ F_WHELLDOWN,		F_WHELLDOWN,		F_SETFONTSIZEDOWN,		F_WHELLDOWN,		F_WHELLDOWN,			F_WHELLDOWN,		F_WHELLDOWN,			F_WHELLDOWN }, },
		{ 0,_T("ホイール左"),			{ F_WHELLLEFT,		F_WHELLLEFT,		F_WHELLLEFT,			F_WHELLLEFT,		F_WHELLLEFT,			F_WHELLLEFT,		F_WHELLLEFT,			F_WHELLLEFT }, },
		{ 0,_T("ホイール右"),			{ F_WHELLRIGHT,		F_WHELLRIGHT,		F_WHELLRIGHT,			F_WHELLRIGHT,		F_WHELLRIGHT,			F_WHELLRIGHT,		F_WHELLRIGHT,			F_WHELLRIGHT }, },
