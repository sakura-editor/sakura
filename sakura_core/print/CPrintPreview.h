...
protected:
	...
	*/
	...
	CColorStrategy *DrawPageText(HDC hdc, int nOffX, int nOffY, int nPageNum, CDlgCancel *pCDlgCancel,
	...
	CColorStrategy *GetColorStrategy(const CStringRef &cStringLine, int iLogic, CColorStrategy *pStrategy,
									 bool &bChange);
