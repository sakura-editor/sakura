...
void CPrint::SettingInitialize( PRINTSETTING& pPrintSetting, const WCHAR* settingName )
{
	...
	wcsncpy( pPrintSetting.m_szPrintFontFaceHan, L"ＭＳ 明朝" );		/* 印刷フォント */
	wcsncpy( pPrintSetting.m_szPrintFontFaceZen, L"ＭＳ 明朝" );		/* 印刷フォント */
	...
	wcsncpy( pPrintSetting.m_szHeaderForm[0], L"$f" );
	...
	wcsncpy( pPrintSetting.m_szFooterForm[1], L"- $p -" );
