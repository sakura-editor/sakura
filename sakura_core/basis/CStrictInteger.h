...
class CStrictInteger
{
  ...
  public:
    ...
    CStrictInteger(const Me &rhs)
    {
        m_value = rhs.m_value;
    }

    //intからの変換は、「明示的に指定したときのみ」可能
    explicit CStrictInteger(int value)
    {
        m_value = value;
    }
    ...
    Me operator+(const Me &rhs) const
    {
        Me ret = *this;
        return ret += rhs;
    }
  ...
  public:
    Me &operator+=(AddsubIntegerType rhs)
    {
        m_value += rhs;
        return *this;
    }
    ...
    Me operator+(AddsubIntegerType rhs) const
    {
        Me ret = *this;
        return ret += rhs;
    }
  ...
  public:
    bool operator<(CmpIntegerType rhs) const
    {
        return m_value < rhs;
    }
    bool operator<=(CmpIntegerType rhs) const
  ...
  public:
    operator CastIntegerType() const
    {
        return m_value;
    }
  ...
  public:
    Me &operator=(const AssignIntegerType &rhs)
    {
        m_value = rhs;
        return *this;
    }
...
#define STRICTINT_LEFT_INT_CMP(TYPE)                                                                           \
    ...
    inline bool operator<(TYPE lhs, const CStrictInteger<N, B0, B1, B2, B3> &rhs)                              \
    {                                                                                                          \
        return rhs > lhs;                                                                                      \
    }                                                                                                          \
    template <int N, bool B0, bool B1, bool B2, bool B3>                                                       \
    ...
    template <int N, bool B0, bool B1, bool B2, bool B3>                                                       \
    inline CStrictInteger<N, B0, B1, B2, B3> operator+(TYPE lhs, const CStrictInteger<N, B0, B1, B2, B3> &rhs) \
    {                                                                                                          \
        return rhs + lhs;                                                                                      \
    }                                                                                                          \
    template <int N, bool B0, bool B1, bool B2, bool B3>                                                       \
