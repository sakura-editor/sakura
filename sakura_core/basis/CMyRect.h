...
public:
	...
	CMyRect(int l, int t, int r, int b) { SetLTRB(l, t, r, b); }
	...
	//!左上座標 (TopLeft)
	CMyPoint UpperLeft() const { return CMyPoint(left, top); }
	//!右下座標 (BottomRight)
	CMyPoint LowerRight() const { return CMyPoint(right, bottom); }
};
