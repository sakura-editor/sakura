...
class CStrictPoint : public SUPER
{
  ...
  public:
    ...
    CStrictPoint(int _x, int _y)
    {
        x = SuperIntType(_x);
        y = SuperIntType(_y);
    }
#ifdef USE_STRICT_INT
    CStrictPoint(IntType _x, IntType _y)
    {
        x = SuperIntType(_x);
        y = SuperIntType(_y);
    }
#endif
    CStrictPoint(const SUPER &rhs)
    {
        x = rhs.x;
        y = rhs.y;
    }
    ...
    //算術演算子
    CStrictPoint &operator+=(const SUPER &rhs)
    {
        x += rhs.x;
        y += rhs.y;
        return *this;
    ...
    //算術演算子２
    CStrictPoint operator+(const SUPER &rhs) const
    {
        CStrictPoint tmp = *this;
        tmp += rhs;
        return tmp;
    }
    CStrictPoint operator-(const SUPER &rhs) const
    ...
    CStrictPoint operator*(int n) const
    {
        CStrictPoint tmp = *this;
        tmp *= n;
        return tmp;
    ...
    void Set(INT_TYPE _x, INT_TYPE _y)
    {
        x = SuperIntType(_x);
        y = SuperIntType(_y);
    }
    void Set(const SUPER &pt)
    {
        x = pt.x;
        y = pt.y;
    }
    void SetX(INT_TYPE _x)
    {
        x = SuperIntType(_x);
    }
    void SetY(INT_TYPE _y)
    {
        y = SuperIntType(_y);
    }
    ...
    //取得
    SuperIntType GetX() const
    {
        return x;
    }
    SuperIntType GetY() const
    {
        return y;
    }
    SUPER Get() const
    ...
    INT_TYPE GetX2() const
    {
        return INT_TYPE(x);
    }
    INT_TYPE GetY2() const
    {
        return INT_TYPE(y);
    }
