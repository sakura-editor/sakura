...
class CFile
{
  public:
    ...
    virtual ~CFile();
    //パス
    const CFilePath &GetFilePathClass() const
    {
        return m_szFilePath;
    }
    ...
    bool IsFileLocking() const
    {
        return m_hLockedFile != INVALID_HANDLE_VALUE;
    }
    EShareMode GetShareMode() const
    {
        return m_nFileShareModeOld;
    }
    void SetShareMode(EShareMode eShareMode)
    {
