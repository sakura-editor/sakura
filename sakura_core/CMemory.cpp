...
UTF-7
     ...
     エンコード方法：
         ...
         ASCII文字と、Base64 エンコードされた Unicode を区別するために、+ と - を使います。 + が現れたら、以後
         は Base64 部分。- が現れたら、あるいはBase64で使われない文字が現れたら以後は ASCII 部分。
     ...
     UTF-7 は、1994/7月に RFC 1642 (現在は Obsolete )として規格化され、1997/5月に RFC 2152 として再規格化されま
     した。 
***/
