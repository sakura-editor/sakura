...
const DWORD p_helpids[] = { //13300
    IDC_CHECK_LOADINI,
    HIDC_CHECK_FILETREE_LOADINI,
    IDC_EDIT_DEFINI,
    HIDC_EDIT_FILETREE_DEFINI,
    IDC_BUTTON_REF1,
    HIDC_BUTTON_FILETREE_REF1,
    IDC_BUTTON_LOAD,
    HIDC_BUTTON_FILETREE_LOAD,
    IDC_RADIO_GREP,
    HIDC_RADIO_FILETREE_GREP,
    IDC_RADIO_FILE,
    HIDC_RADIO_FILETREE_FILE,
    IDC_RADIO_FOLDER,
    HIDC_RADIO_FILETREE_FOLDER,
    IDC_STATIC_PATH,
    HIDC_STATIC_FILETREE_PATH,
    IDC_EDIT_PATH,
    HIDC_EDIT_FILETREE_PATH,
    IDC_BUTTON_REF2,
    HIDC_BUTTON_FILETREE_REF2,
    IDC_BUTTON_PATH_MENU,
    HIDC_BUTTON_FILETREE_PATH_MENU,
    IDC_EDIT_LABEL,
    HIDC_EDIT_FILETREE_LABEL,
    IDC_STATIC_FILE,
    HIDC_STATIC_FILETREE_FILE,
    IDC_EDIT_FILE,
    HIDC_EDIT_FILETREE_FILE,
    IDC_CHECK_HIDDEN,
    HIDC_CHECK_FILETREE_HIDDEN,
    IDC_CHECK_READONLY,
    HIDC_CHECK_FILETREE_READONLY,
    IDC_CHECK_SYSTEM,
    HIDC_CHECK_FILETREE_SYSTEM,
    IDC_BUTTON_DELETE,
    HIDC_BUTTON_FILETREE_DELETE,
    IDC_BUTTON_INSERT,
    HIDC_BUTTON_FILETREE_INSERT,
    IDC_BUTTON_INSERT_A,
    HIDC_BUTTON_FILETREE_INSERT_A,
    IDC_BUTTON_ADD,
    HIDC_BUTTON_FILETREE_ADD,
    IDC_BUTTON_UPDATE,
    HIDC_BUTTON_FILETREE_UPDATE,
    IDC_BUTTON_FILEADD,
    HIDC_BUTTON_FILETREE_FILEADD,
    IDC_BUTTON_REPLACE,
    HIDC_BUTTON_FILETREE_REPLACE,
    IDC_BUTTON_UP,
    HIDC_BUTTON_FILETREE_UP,
    IDC_BUTTON_DOWN,
    HIDC_BUTTON_FILETREE_DOWN,
    IDC_BUTTON_RIGHT,
    HIDC_BUTTON_FILETREE_RIGHT,
    IDC_BUTTON_LEFT,
    HIDC_BUTTON_FILETREE_LEFT,
    IDC_TREE_FL,
    HIDC_TREE_FILETREE_FL,
    IDC_BUTTON_IMPORT,
    HIDC_BUTTON_FILETREE_IMPORT,
    HIDC_BUTTON_EXPORT,
    HIDC_BUTTON_FILETREE_EXPORT,
    IDOK,
    HIDC_FILETREE_IDOK,
    IDCANCEL,
    HIDC_FILETREE_IDCANCEL,
    IDC_BUTTON_HELP,
    ...
    switch (wID)
    {
        ...
        case IDC_RADIO_FOLDER:
        {
            ...
            if (htiItem != NULL && !IsDlgButtonCheckedBool(GetHwnd(), IDC_RADIO_FOLDER))
            {
                ...
                tvi.hItem = htiItem;
                if (TreeView_GetItem(hwndTree, &tvi) && m_fileTreeSetting.m_aItems[tvi.lParam].m_eFileTreeItemType == EFileTreeItemType_Folder && NULL != TreeView_GetChild(hwndTree, htiItem))
                {
        ...
        case IDC_BUTTON_PATH_MENU:
        {
            ...
            if (nId != 0)
            {
                ...
                const WCHAR *pszPaths[] = {L"<iniroot>", L"%MYDOC%", L"%MYMUSIC%", L"%MYVIDEO%", L"%DESKTOP%", L"%TEMP%", L"%SAKURA%", L"%SAKURADATA%"};
        ...
        case IDC_BUTTON_DELETE:
        {
            ...
            if (htiItem != NULL)
            {
                if (TreeView_GetChild(hwndTree, htiItem) != NULL && IDCANCEL == ::MYMESSAGEBOX(GetHwnd(), MB_OKCANCEL | MB_ICONQUESTION, GSTR_APPNAME, LS(STR_PROPCOMMAINMENU_DEL)))
                {
                    return TRUE;
                }
