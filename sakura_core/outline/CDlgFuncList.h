...
class CDlgFuncList final : public CDialog
{
  public:
	...
	*/
    ...
    bool IsDocking()
    {
        return m_eDockSide > DOCKSIDE_FLOAT;
    }
    EDockSide GetDockSide()
    {
        return m_eDockSide;
    }
  ...
  protected:
    ...
    CommonSetting_OutLine &CommonSet(void)
    {
        return m_pShareData->m_Common.m_sOutline;
    }
    STypeConfig &TypeSet(void)
    {
        return m_type;
    }
    int &ProfDockSet()
    {
        return CommonSet().m_nOutlineDockSet;
    }
    BOOL &ProfDockSync()
    {
        return CommonSet().m_bOutlineDockSync;
    }
    BOOL &ProfDockDisp()
    {
    ...
    int &ProfDockTop()
    {
        return (ProfDockSet() == 0) ? CommonSet().m_cyOutlineDockTop : TypeSet().m_cyOutlineDockTop;
    }
    int &ProfDockRight()
    {
