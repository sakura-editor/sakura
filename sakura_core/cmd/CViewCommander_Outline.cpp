...
*/
BOOL CViewCommander::Command_FUNCLIST(int nAction, EOutlineType nOutlineType = OUTLINE_DEFAULT)
{
	...
	// ダイアログタイトルを上書き
	if (!sTitleOverride.empty()) { GetEditWindow()->m_cDlgFuncList.SetWindowText(sTitleOverride.c_str()); }
