...
//	int Command_UP_BOX( BOOL );				/* (矩形選択)カーソル上移動 */
	...
	CColorStrategy* GetColorStrategyHTML(const CStringRefW&	cStringLine, int iLogic, const CColorStrategyPool*	pool, CColorStrategy**	ppStrategy, CColorStrategy** pStrategyFound, bool& bChange);
