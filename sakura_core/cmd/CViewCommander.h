...
//	int Command_UP_BOX( BOOL );				/* (矩形選択)カーソル上移動 */
	...
	void Command_SEARCH_NEXT(bool bRedraw, HWND hwndParent, bool bChangeCurRegexp, bool bReplaceAll, const WCHAR* pszNotFoundMessage, CLogicRange*	pcSelectLogic = NULL); /* 次を検索 */
