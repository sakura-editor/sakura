...
class CViewCommander
{
  ...
  public:
    ...
    void Command_INSTEXT(bool bRedraw, const wchar_t *pszText, CLogicInt nTextLen, bool bNoWaitCursor, bool bLinePaste = false, bool bFastMode = false, const CLogicRange *psDelRangeLogicFast = NULL); // 2004.05.14 Moca テキストを貼り付け '\0'対応
