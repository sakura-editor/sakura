...
public:
	...
	int  ScrollWindowEx(int dx, int dy, const RECT *prcScroll, const RECT *prcClip, HRGN hrgnUpdate, RECT *prcUpdate,
						UINT uFlags)
	{
	...
	HWND GetAncestor(UINT gaFlags) const { return ::GetAncestor(m_hWnd, gaFlags); }
