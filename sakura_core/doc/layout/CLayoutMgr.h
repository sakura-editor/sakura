...
class CLayoutMgr : public CProgressSubject
{
  ...
  public:
    ...
    {
        return m_nTabSpace * m_nCharLayoutXPerKeta;
    }
    CKetaXInt GetTabSpaceKetas() const
    {
        return m_nTabSpace;
    }
  ...
  public:
    ...
    //先頭と末尾
    CLayout *GetTopLayout()
    {
        return m_pLayoutTop;
    }
    CLayout *GetBottomLayout()
    {
        return m_pLayoutBot;
    }
    const CLayout *GetTopLayout() const
    {
        return m_pLayoutTop;
    }
    const CLayout *GetBottomLayout() const
    {
        return m_pLayoutBot;
    }
    ...
    CKetaXInt GetActualTabSpaceKetas(CKetaXInt pos) const
    {
        return GetTabSpaceKetas() - pos % GetTabSpaceKetas();
    }
    ...
    CLayoutInt GetActualTsvSpace(CLayoutInt pos, wchar_t ch) const
    {
        ...
        else if ((m_tsvInfo.m_nTsvMode == TSV_MODE_TSV && ch == WCODE::TAB) || (m_tsvInfo.m_nTsvMode == TSV_MODE_CSV && ch == L','))
        {
    ...
    CKetaXInt GetMaxLineKetas() const
    {
        return m_nMaxLineKetas;
    }
    CLayoutXInt GetMaxLineLayout() const
    {
        return m_nMaxLineKetas * m_nCharLayoutXPerKeta;
    }
    ...
    CLayoutInt GetMaxTextWidth(void) const
    {
        return m_nTextWidth;
    } // 2009.08.28 nasukoji	テキスト最大幅を返す
  ...
  public:
	...
	*/
    ...
    CPixelXInt GetWidthPerKeta() const
    {
        return Int(m_nCharLayoutXPerKeta);
    }
  ...
  private:
    bool _ExistKinsokuKuto(wchar_t wc) const
    {
        return m_pszKinsokuKuto_1.exist(wc);
    }
    bool _ExistKinsokuHead(wchar_t wc) const
    {
