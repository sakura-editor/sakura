...
class CDocLineMgr
{
  public:
    ...
    const CDocLine *GetDocLineTop() const
    {
        return m_pDocLineTop;
    } //!< 先頭行を取得
    CDocLine *GetDocLineTop()
    {
        return m_pDocLineTop;
    } //!< 先頭行を取得
    const CDocLine *GetDocLineBottom() const
    {
        return m_pDocLineBot;
    } //!< 最終行を取得
    CDocLine *GetDocLineBottom()
    {
        return m_pDocLineBot;
    } //!< 最終行を取得
