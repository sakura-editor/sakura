...
static ColorInfoIni ColorInfo_DEFAULT[] = {
	...
	{STR_COLOR_TAB,
	 {TRUE,
	  {FALSE, FALSE},
	  {RGB(128, 128, 128), RGB(255, 251, 240)}}}, // Jan. 19, 2001 JEPRO RGB(192,192,192)より濃いグレーに変更
	...
	{STR_COLOR_NUMBER,
	 {FALSE, {FALSE, FALSE}, {RGB(235, 0, 0), RGB(255, 251, 240)}}}, //@@@ 2001.02.17 by MIK		//Mar. 7, 2001 JEPRO
																	 // RGB(0,0,255)を変更  Mar.10, 2001 標準は色なしに
	...
	{STR_COLOR_KEYWORD2,
	 {TRUE,
	  {FALSE, FALSE},
	  {RGB(255, 128, 0),
	   RGB(255, 251, 240)}}}, // Dec. 4, 2000 MIK added	//Jan. 19, 2001 JEPRO キーワード1とは違う色に変更
	{STR_COLOR_KEYWORD3,
	 {TRUE,
	  {FALSE, FALSE},
	  {RGB(255, 128, 0),
...
int GetDefaultColorInfoCount() { return _countof(ColorInfo_DEFAULT); }
