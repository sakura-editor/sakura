...
class CFuncListManager
{
  public:
    ...
    bool SearchFuncListMark(const CDocLineMgr *pcDocLineMgr, CLogicInt nLineNum, ESearchDirection bPrevOrNext, CLogicInt *pnLineNum) const; //!< 関数リストマーク検索
