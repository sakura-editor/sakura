...
void CShareData_IO::ShareData_IO_Common( CDataProfile& cProfile )
{
	...
	cProfile.IOProfileData( pszSecName, LTEXT("bPageScroolByMButtonWheel")	, common.m_sGeneral.m_bPageScroolByMButtonWheel );	// 2008.10.06 nasukoji
...
void CShareData_IO::ShareData_IO_Types( CDataProfile& cProfile )
{
	...
	for( i = 0; i < MAX_TYPES; ++i ){
		// 2005.04.07 D.S.Koba
		STypeConfig& types = CDocTypeManager().GetTypeSetting(CTypeConfig(i));
