...
static const int MAX_TOOLBAR_ICON_COLS		=  32;	//アイコンBMPの最大列数
static const int MAX_TOOLBAR_ICON_ROWS		=  15;	//アイコンBMPの最大行数
static const int MAX_TOOLBAR_ICON_COUNT		= MAX_TOOLBAR_ICON_COLS * MAX_TOOLBAR_ICON_ROWS; // =480
