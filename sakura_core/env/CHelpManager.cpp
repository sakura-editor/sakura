...
{
	if (type && type->m_szExtHelp[0] != L'\0') { return type->m_szExtHelp; }
...
{
	if (type && type->m_szExtHtmlHelp[0] != L'\0') { return type->m_szExtHtmlHelp; }
...
{
	if (type && type->m_szExtHtmlHelp[0] != L'\0') { return type->m_bHtmlHelpIsSingle; }
