...
#define HIDC_RADIO_BACKUP_TYPE2NEWHID                                                                                  \
	10061 //バックアップの種類（日付・時刻）// 2002.11.09 Moca
		  //ヘルプ・ソースのコメントがTYPE2と逆だったため名称変更しヘルプファイルにIDを合わせた
#define HIDC_RADIO_BACKUP_TYPE3NEWHID                                                                                  \
	10062 //バックアップの種類（連番）// 2002.11.09 Moca
		  //ヘルプ・ソースのコメントがTYPE3と逆だったため名称変更しヘルプファイルにIDを合わせた
...
//#define HIDC_BUTTON_HOKANFILE_REF				10600 //入力補完 単語ファイル参照			//Jul. 05, 2001 JEPRO
//タイプ別に移動
//#define HIDC_BUTTON_KEYWORDHELPFILE_REF			10601 //キーワードヘルプファイル参照	//Jul. 05, 2001 JEPRO
//タイプ別に移動
...
//#define HIDC_CHECK_HOKANLOHICASE				10611 //入力補完の英大文字小文字			//Jul. 05, 2001 JEPRO
//タイプ別に移動
...
//#define HIDC_CHECK_USEKEYWORDHELP				10616 //キーワードヘルプ機能				//Jul. 05, 2001 JEPRO
//タイプ別に移動
#define HIDC_CHECK_HTMLHELPISSINGLE 10617 //ビューアの複数起動
#define HIDC_CHECK_CLICKKEYSEARCH	10618 //キャレット位置の単語を辞書検索		// 2006.03.24 fon
//#define HIDC_EDIT_HOKANFILE						10640 //単語ファイル名					//Jul. 05, 2001 JEPRO
//タイプ別に移動
//#define HIDC_EDIT_KEYWORDHELPFILE				10641 //辞書ファイル名						//Jul. 05, 2001 JEPRO
//タイプ別に移動
...
//#define HIDC_CHECK_ACCELTBL_EACHWIN				10760 //ウィンドウ毎にアクセラレータテーブルを作成する(Wine用)	// nasukoji
//2009.08.11
...
#define HIDC_CHECK_NOMOVE_ACTIVATE_BY_MOUSE                                                                            \
	10920 //マウスクリックでアクティブになったときはカーソルをクリック位置に移動しない 2007.10.08 genta
