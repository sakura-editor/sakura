...
static const DWORD p_helpids2[] = { //11400
    IDC_LIST_COLORS,
    HIDC_LIST_COLORS, //色指定
    IDC_CHECK_DISP,
    HIDC_CHECK_DISP, //色分け表示
    IDC_CHECK_BOLD,
    HIDC_CHECK_BOLD, //太字
    IDC_CHECK_UNDERLINE,
    HIDC_CHECK_UNDERLINE, //下線
    IDC_BUTTON_TEXTCOLOR,
    HIDC_BUTTON_TEXTCOLOR, //文字色
    IDC_BUTTON_BACKCOLOR,
    HIDC_BUTTON_BACKCOLOR, //背景色
    IDC_BUTTON_SAMETEXTCOLOR,
    HIDC_BUTTON_SAMETEXTCOLOR, //文字色統一
    IDC_BUTTON_SAMEBKCOLOR,
    HIDC_BUTTON_SAMEBKCOLOR, //背景色統一
    IDC_BUTTON_IMPORT,
    HIDC_BUTTON_IMPORT_COLOR, //インポート
    IDC_BUTTON_EXPORT,
    HIDC_BUTTON_EXPORT_COLOR, //エクスポート
    IDC_COMBO_SET,
    HIDC_COMBO_SET_COLOR, //強調キーワード１セット名
    IDC_BUTTON_KEYWORD_SELECT,
    HIDC_BUTTON_KEYWORD_SELECT, //強調キーワード2～10	// 2006.08.06 ryoji
    IDC_EDIT_BLOCKCOMMENT_FROM,
    HIDC_EDIT_BLOCKCOMMENT_FROM, //ブロックコメント１開始
    IDC_EDIT_BLOCKCOMMENT_TO,
    HIDC_EDIT_BLOCKCOMMENT_TO, //ブロックコメント１終了
    IDC_EDIT_BLOCKCOMMENT_FROM2,
    HIDC_EDIT_BLOCKCOMMENT_FROM2, //ブロックコメント２開始
    IDC_EDIT_BLOCKCOMMENT_TO2,
    HIDC_EDIT_BLOCKCOMMENT_TO2, //ブロックコメント２終了
    IDC_EDIT_LINECOMMENT,
    HIDC_EDIT_LINECOMMENT, //行コメント１
    IDC_EDIT_LINECOMMENT2,
    HIDC_EDIT_LINECOMMENT2, //行コメント２
    IDC_EDIT_LINECOMMENT3,
    HIDC_EDIT_LINECOMMENT3, //行コメント３
    IDC_EDIT_LINECOMMENTPOS,
    HIDC_EDIT_LINECOMMENTPOS, //桁数１
    IDC_EDIT_LINECOMMENTPOS2,
    HIDC_EDIT_LINECOMMENTPOS2, //桁数２
    IDC_EDIT_LINECOMMENTPOS3,
    HIDC_EDIT_LINECOMMENTPOS3, //桁数３
    IDC_CHECK_LCPOS,
    HIDC_CHECK_LCPOS, //桁指定１
    IDC_CHECK_LCPOS2,
    HIDC_CHECK_LCPOS2, //桁指定２
    IDC_CHECK_LCPOS3,
    HIDC_CHECK_LCPOS3, //桁指定３
    IDC_COMBO_STRINGLITERAL,
    HIDC_COMBO_STRINGLITERAL, //文字列エスケープ
    IDC_CHECK_STRINGLINEONLY,
    HIDC_CHECK_STRINGLINEONLY, //文字列は行内のみ
    IDC_CHECK_STRINGENDLINE,
    HIDC_CHECK_STRINGENDLINE, //終了文字がない場合行末まで色分け
    IDC_EDIT_VERTLINE,
    HIDC_EDIT_VERTLINE, //縦線の桁指定	// 2006.08.06 ryoji
    //	IDC_STATIC,						-1,
    0,
    0};
...
LRESULT APIENTRY ColorList_SubclassProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsg)
    {
        ...
        case WM_LBUTTONUP:
            ...
            pColorInfo = (ColorInfo *)List_GetItemData(hwnd, nIndex);
            /* 色分け/表示 する */
            if (2 <= xPos && xPos <= 16 && (0 == (g_ColorAttributeArr[nIndex].fAttribute & COLOR_ATTRIB_FORCE_DISP)) // 2006.12.18 ryoji フラグ利用で簡素化
            )
            {
                ...
                /* 前景色見本 矩形 */
                if (m_fgColorSampleLeft <= xPos && xPos <= m_fgColorSampleRight && (0 == (g_ColorAttributeArr[nIndex].fAttribute & COLOR_ATTRIB_NO_TEXT)))
            {
                /* 色選択ダイアログ */
                ...
                /* 背景色見本 矩形 */
                if (m_bgColorSampleLeft <= xPos && xPos <= m_bgColorSampleRight && (0 == (g_ColorAttributeArr[nIndex].fAttribute & COLOR_ATTRIB_NO_BACK)) // 2006.12.18 ryoji フラグ利用で簡素化
                )
            {
                /* 色選択ダイアログ */
                // 2005.11.30 Moca カスタム色保持
