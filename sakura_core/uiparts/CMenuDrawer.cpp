...
/* 66 */		F_OPEN_COMMAND_PROMPT			/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//ダミー
/* 67 */		F_OPEN_POWERSHELL				/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//ダミー
...
/* 82 */		F_OPEN_COMMAND_PROMPT_AS_ADMIN	/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//画面の先頭に移動(未実装)
/* 83 */		F_OPEN_POWERSHELL_AS_ADMIN		/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//画面の最後に移動(未実装)
