...
LRESULT CSplitBoxWnd::OnPaint(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    if (m_bVertical)
    {
        ...
        Draw3dRect(hdc, 1, 1, nCxVScroll - 2, nVSplitHeight - 2, ::GetSysColor(COLOR_3DHILIGHT), ::GetSysColor(COLOR_3DSHADOW));
    }
    else
    {
        /* 水平分割ボックスの描画 */
        ...
        Draw3dRect(hdc, 1, 1, nHSplitWidth - 2, nCyHScroll - 2, ::GetSysColor(COLOR_3DHILIGHT), ::GetSysColor(COLOR_3DSHADOW));
    }
