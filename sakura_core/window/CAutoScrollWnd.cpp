...
HWND CAutoScrollWnd::Create(HINSTANCE hInstance, HWND hwndParent, bool bVertical, bool bHorizontal,
							const CMyPoint &point, CEditView *view)
{
	...
	/* ウィンドウクラス作成 */
	RegisterWC(hInstance, NULL, NULL, hCursor, (HBRUSH)(COLOR_3DFACE + 1), NULL, pszClassName);
...
{
	if (m_cView->m_nAutoScrollMode) { m_cView->AutoScrollExit(); }
	return 0;
}
