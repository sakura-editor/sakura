...
//	変数削除
	...
	if( NULL != m_cStatusBar.GetStatusHwnd() ){
		...
		const WCHAR* pszLabel[] = { L"", L"99999 行 9999 列", L"CRLF", L"AAAAAAAAAAAA", L"UTF-16 BOM付", L"REC", L"上書", L"9999 % (999.9/999.9 pt)" };	//Oct. 30, 2000 JEPRO 千万行も要らん	文字コード枠を広げる 2008/6/21	Uchi
