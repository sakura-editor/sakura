...
protected:
	/* 仮想関数 */
	LRESULT DispatchEvent_WM_APP(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
		override; /* アプリケーション定義のメッセージ(WM_APP <= msg <= 0xBFFF) */
	...
	LRESULT OnLButtonDblClk(HWND hwnd, UINT uMsg, WPARAM wParam,
							LPARAM lParam) override; /* マウス左ボタンダブルクリック時の処理 */
	/*
	||  実装ヘルパ関数
	*/
