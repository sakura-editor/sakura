...
protected:
	...
	// 非実装提供
	virtual bool HandleFunction(CEditView *View, EFunctionCode ID, const VARIANT *Arguments, const int ArgSize,
								VARIANT &Result)		   = 0; //関数を処理する
	virtual bool HandleCommand(CEditView *View, EFunctionCode ID, const WCHAR *Arguments[], const int ArgLengths[],
							   const int ArgSize)		   = 0; //コマンドを処理する
