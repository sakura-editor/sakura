...
MacroFuncInfo CSMacroMgr::m_MacroFuncInfoCommandArr[] = {
	...
	{F_FILESAVEAS_DIALOG,
	 LTEXT("FileSaveAsDialog"),
	 {VT_BSTR, VT_I4, VT_I4, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //名前を付けて保存(ダイアログ) 2013.05.02
	{F_FILESAVEAS, LTEXT("FileSaveAs"), {VT_BSTR, VT_I4, VT_I4, VT_EMPTY}, VT_EMPTY, NULL}, //名前を付けて保存
	{F_FILECLOSE,
	 LTEXT("FileClose"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //閉じて(無題)	//Oct. 17, 2000 jepro 「ファイルを閉じる」というキャプションを変更
	...
	{F_FILE_REOPEN,
	 ...
	 VT_EMPTY,
	 NULL}, //開き直す	//Dec. 4, 2002 genta
	{F_FILE_REOPEN_SJIS,
	 LTEXT("FileReopenSJIS"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // SJISで開き直す
	...
	{F_FILE_REOPEN_LATIN1,
	 LTEXT("FileReopenLatin1"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // Latin1で開き直す	// 2010/3/20 Uchi
	{F_FILE_REOPEN_UNICODE,
	 LTEXT("FileReopenUNICODE"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // Unicodeで開き直す
	{F_FILE_REOPEN_UNICODEBE,
	 LTEXT("FileReopenUNICODEBE"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // UnicodeBEで開き直す
	{F_FILE_REOPEN_UTF8,
	 LTEXT("FileReopenUTF8"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // UTF-8で開き直す
	{F_FILE_REOPEN_CESU8,
	 LTEXT("FileReopenCESU8"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // CESU-8で開き直す
	{F_FILE_REOPEN_UTF7,
	 LTEXT("FileReopenUTF7"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL},																				 // UTF-7で開き直す
	...
	{F_PRINT_PAGESETUP,
	 LTEXT("PrintPageSetup"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //印刷ページ設定	//Sept. 14, 2000 jepro 「印刷のページレイアウトの設定」から変更
	{F_OPEN_HfromtoC,
	 LTEXT("OpenHfromtoC"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_PROPERTY_FILE,
	 ...
	 NULL}, //ファイルのプロパティ
	{F_EXITALLEDITORS,
	 LTEXT("ExitAllEditors"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //編集の全終了	// 2007.02.13 ryoji 追加
	{F_EXITALL,
	 LTEXT("ExitAll"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //サクラエディタの全終了	//Dec. 27, 2000 JEPRO 追加
	{F_PUTFILE,
	 LTEXT("PutFile"),
	 {VT_BSTR, VT_I4, VT_I4, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // 作業中ファイルの一時出力 2006.12.10 maru
	{F_INSFILE,
	 LTEXT("InsFile"),
	 {VT_BSTR, VT_I4, VT_I4, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // キャレット位置にファイル挿入 2006.12.10 maru
	...
	{F_WordDeleteToStart,
	 LTEXT("WordDeleteToStart"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //単語の左端まで削除
	{F_WordDeleteToEnd,
	 LTEXT("WordDeleteToEnd"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //単語の右端まで削除
	...
	{F_LineCutToEnd,
	 ...
	 NULL}, //行末まで切り取り(改行単位)
	{F_LineDeleteToStart,
	 LTEXT("LineDeleteToStart"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //行頭まで削除(改行単位)
	{F_LineDeleteToEnd,
	 LTEXT("LineDeleteToEnd"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //行末まで削除(改行単位)
	...
	{F_LTRIM,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //左(先頭)の空白を削除 2001.12.03 hor
	{F_RTRIM,
	 LTEXT("RTrim"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //右(末尾)の空白を削除 2001.12.03 hor
	{F_SORT_ASC,
	 LTEXT("SortAsc"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //選択行の昇順ソート 2001.12.06 hor
	{F_SORT_DESC,
	 LTEXT("SortDesc"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //選択行の降順ソート 2001.12.06 hor
	...
	{F_GOLINETOP,
	 ...
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //行頭に移動(折り返し単位/改行単位)
	{F_GOLINEEND, LTEXT("GoLineEnd"), {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL}, //行末に移動(折り返し単位)
	{F_HalfPageUp,
	 LTEXT("HalfPageUp"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //半ページアップ	//Oct. 6, 2000 JEPRO 名称をPC-AT互換機系に変更(ROLL→PAGE) //Oct. 10, 2000 JEPRO 名称変更
	{F_HalfPageDown,
	 LTEXT("HalfPageDown"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //半ページダウン	//Oct. 6, 2000 JEPRO 名称をPC-AT互換機系に変更(ROLL→PAGE) //Oct. 10, 2000 JEPRO 名称変更
	{F_1PageUp,
	 LTEXT("PageUp"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //１ページアップ	//Oct. 10, 2000 JEPRO 従来のページアップを半ページアップと名称変更し１ページアップを追加
	{F_1PageUp,
	 LTEXT("1PageUp"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_1PageDown,
	 ...
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //１ページダウン	//Oct. 10, 2000 JEPRO 従来のページダウンを半ページダウンと名称変更し１ページダウンを追加
	{F_1PageDown,
	 LTEXT("1PageDown"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_JUMPHIST_SET,
	 ...
	 NULL}, //現在位置を移動履歴に登録
	{F_WndScrollDown,
	 LTEXT("F_WndScrollDown"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //テキストを１行下へスクロール	// 2001/06/20 asa-o
	{F_WndScrollUp,
	 LTEXT("F_WndScrollUp"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //テキストを１行上へスクロール	// 2001/06/20 asa-o
	{F_GONEXTPARAGRAPH,
	 LTEXT("GoNextParagraph"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //次の段落へ移動
	{F_GOPREVPARAGRAPH,
	 LTEXT("GoPrevParagraph"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //前の段落へ移動
	{F_MODIFYLINE_NEXT,
	 LTEXT("GoModifyLineNext"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //次の変更行へ移動
	{F_MODIFYLINE_PREV,
	 LTEXT("GoModifyLinePrev"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL},																				  //前の変更行へ移動
	{F_MOVECURSOR, LTEXT("MoveCursor"), {VT_I4, VT_I4, VT_I4, VT_EMPTY}, VT_EMPTY, NULL}, //カーソル移動
	{F_MOVECURSORLAYOUT,
	 LTEXT("MoveCursorLayout"),
	 {VT_I4, VT_I4, VT_I4, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //カーソル移動(レイアウト単位)
	...
	{F_SELECTLINE,
	 ...
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // 1行選択	// 2007.10.13 nasukoji
	{F_BEGIN_SEL,
	 LTEXT("BeginSelect"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //範囲選択開始 Mar. 5, 2001 genta 名称修正
	...
	{F_UP2_SEL,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)カーソル上移動(２行ごと)
	{F_DOWN2_SEL,
	 LTEXT("Down2_Sel"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)カーソル下移動(２行ごと)
	{F_WORDLEFT_SEL,
	 LTEXT("WordLeft_Sel"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_GOLINETOP_SEL,
	 ...
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)行頭に移動(折り返し単位/改行単位)
	{F_GOLINEEND_SEL,
	 LTEXT("GoLineEnd_Sel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)行末に移動(折り返し単位)
	{F_HalfPageUp_Sel,
	 LTEXT("HalfPageUp_Sel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)半ページアップ	//Oct. 6, 2000 JEPRO 名称をPC-AT互換機系に変更(ROLL→PAGE) //Oct. 10, 2000 JEPRO
			//名称変更
	{F_HalfPageDown_Sel,
	 LTEXT("HalfPageDown_Sel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)半ページダウン	//Oct. 6, 2000 JEPRO 名称をPC-AT互換機系に変更(ROLL→PAGE) //Oct. 10, 2000 JEPRO
			//名称変更
	{F_1PageUp_Sel,
	 LTEXT("PageUp_Sel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)１ページアップ	//Oct. 10, 2000 JEPRO
	...
	{F_1PageDown_Sel,
	 ...
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)１ページダウン	//Oct. 10, 2000 JEPRO
			//従来のページダウンを半ページダウンと名称変更し１ページダウンを追加
	{F_1PageDown_Sel,
	 LTEXT("1PageDown_Sel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_GOFILETOP_SEL,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)ファイルの先頭に移動
	{F_GOFILEEND_SEL,
	 LTEXT("GoFileEnd_Sel"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)ファイルの最後に移動
	{F_GONEXTPARAGRAPH_SEL,
	 LTEXT("GoNextParagraph_Sel"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)次の段落へ移動
	{F_GOPREVPARAGRAPH_SEL,
	 LTEXT("GoPrevParagraph_Sel"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)前の段落へ移動
	{F_MODIFYLINE_NEXT_SEL,
	 LTEXT("GoModifyLineNext_Sel"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)次の変更行へ移動
	{F_MODIFYLINE_PREV_SEL,
	 LTEXT("GoModifyLinePrev_Sel"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(範囲選択)前の変更行へ移動
	...
	{F_UP2_BOX,
	 ...
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)カーソル上移動(２行ごと)
	{F_DOWN2_BOX,
	 LTEXT("Down2_BoxSel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)カーソル下移動(２行ごと)
	{F_WORDLEFT_BOX,
	 LTEXT("WordLeft_BoxSel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)単語の左端に移動
	{F_WORDRIGHT_BOX,
	 LTEXT("WordRight_BoxSel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)単語の右端に移動
	{F_GOLOGICALLINETOP_BOX,
	 LTEXT("GoLogicalLineTop_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)行頭に移動(改行単位)
	{F_GOLINETOP_BOX,
	 LTEXT("GoLineTop_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)行頭に移動(折り返し単位/改行単位)
	{F_GOLINEEND_BOX,
	 LTEXT("GoLineEnd_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)行末に移動(折り返し単位)
	{F_HalfPageUp_BOX,
	 LTEXT("HalfPageUp_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)半ページアップ
	{F_HalfPageDown_BOX,
	 LTEXT("HalfPageDown_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)半ページダウン
	{F_1PageUp_BOX,
	 ...
	 NULL}, //(矩形選択)１ページアップ
	{F_1PageUp_BOX,
	 LTEXT("1PageUp_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)１ページアップ
	{F_1PageDown_BOX,
	 LTEXT("PageDown_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)１ページダウン
	{F_1PageDown_BOX,
	 LTEXT("1PageDown_BoxSel"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)１ページダウン
	{F_GOFILETOP_BOX,
	 LTEXT("GoFileTop_BoxSel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)ファイルの先頭に移動
	{F_GOFILEEND_BOX,
	 LTEXT("GoFileEnd_BoxSel"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //(矩形選択)ファイルの最後に移動
	...
	{F_CUT,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //切り取り(選択範囲をクリップボードにコピーして削除)
	{F_COPY,
	 LTEXT("Copy"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //コピー(選択範囲をクリップボードにコピー)
	{F_PASTE,
	 LTEXT("Paste"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //貼り付け(クリップボードから貼り付け)
	{F_COPY_ADDCRLF,
	 LTEXT("CopyAddCRLF"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //折り返し位置に改行をつけてコピー
	{F_COPY_CRLF,
	 LTEXT("CopyCRLF"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // CRLF改行でコピー(選択範囲を改行コード=CRLFでコピー)
	{F_PASTEBOX,
	 LTEXT("PasteBox"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //矩形貼り付け(クリップボードから矩形貼り付け)
	...
	{F_COPYLINESASPASSAGE,
	 LTEXT("CopyLinesAsPassage"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //選択範囲内全行引用符付きコピー
	{F_COPYLINESWITHLINENUMBER,
	 LTEXT("CopyLinesWithLineNumber"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //選択範囲内全行行番号付きコピー
	{F_COPY_COLOR_HTML,
	 LTEXT("CopyColorHtml"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //選択範囲内色付きHTMLコピー
	{F_COPY_COLOR_HTML_LINENUMBER,
	 LTEXT("CopyColorHtmlWithLineNumber"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //選択範囲内行番号色付きHTMLコピー
	{F_COPYPATH,
	 LTEXT("CopyPath"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //このファイルのパス名をクリップボードにコピー
	{F_COPYDIRPATH,
	 LTEXT("CopyDirPath"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //このファイルのフォルダ名をクリップボードにコピー
	{F_COPYFNAME,
	 LTEXT("CopyFilename"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //このファイル名をクリップボードにコピー // 2002/2/3 aroka
	{F_COPYTAG,
	 LTEXT("CopyTag"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //このファイルのパス名とカーソル位置をコピー	//Sept. 15, 2000 jepro 上と同じ説明になっていたのを修正
	{F_CREATEKEYBINDLIST,
	 LTEXT("CopyKeyBindList"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //キー割り当て一覧をコピー	//Sept. 15, 2000 JEPRO 追加 //Dec. 25, 2000 復活
	...
	{F_CTRL_CODE_DIALOG,
	 LTEXT("CtrlCodeDialog"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //コントロールコードの入力(ダイアログ)	//@@@ 2002.06.02 MIK
	{F_CTRL_CODE,
	 LTEXT("CtrlCode"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //コントロールコードの入力 2013.12.12
	{F_INS_FILE_USED_RECENTLY,
	 LTEXT("InsertFileUsedRecently"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // 最近使ったファイル挿入
	{F_INS_FOLDER_USED_RECENTLY,
	 LTEXT("InsertFolderUsedRecently"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // 最近使ったフォルダ挿入
	...
	{F_TOHANKATA, LTEXT("ToHankata"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 全角カタカナ→半角カタカナ */ // Aug. 29, 2002 ai
	{F_TOZENEI, LTEXT("ToZenEi"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 半角英数→全角英数 */																	 // July. 30, 2001 Misaka
	{F_TOHANEI, LTEXT("ToHanEi"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL}, /* 全角英数→半角英数 */
	{F_TOZENKAKUKATA, LTEXT("ToZenKata"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 半角＋全ひら→全角・カタカナ */ // Sept. 17, 2000 jepro 説明を「半角→全角カタカナ」から変更
	{F_TOZENKAKUHIRA, LTEXT("ToZenHira"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 半角＋全カタ→全角・ひらがな */ // Sept. 17, 2000 jepro 説明を「半角→全角ひらがな」から変更
	{F_HANKATATOZENKATA,
	 LTEXT("HanKataToZenKata"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, /* 半角カタカナ→全角カタカナ */
	{F_HANKATATOZENHIRA,
	 LTEXT("HanKataToZenHira"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, /* 半角カタカナ→全角ひらがな */
	{F_TABTOSPACE, LTEXT("TABToSPACE"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL}, /* TAB→空白 */
	{F_SPACETOTAB, LTEXT("SPACEToTAB"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	...
	{F_CODECNV_UNICODE2SJIS,
	 LTEXT("CodeCnvUNICODEtoSJIS"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // Unicode→SJISコード変換
	{F_CODECNV_UNICODEBE2SJIS,
	 LTEXT("CodeCnvUNICODEBEtoSJIS"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // UnicodeBE→SJISコード変換
	{F_CODECNV_UTF82SJIS,
	 LTEXT("UTF8toSJIS"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, /* UTF-8→SJISコード変換 */
	{F_CODECNV_UTF72SJIS,
	 LTEXT("UTF7toSJIS"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, /* UTF-7→SJISコード変換 */
	{F_CODECNV_SJIS2JIS,
	 LTEXT("SJIStoJIS"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_CODECNV_SJIS2UTF8,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, /* SJIS→UTF-8コード変換 */
	{F_CODECNV_SJIS2UTF7,
	 LTEXT("SJIStoUTF7"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, /* SJIS→UTF-7コード変換 */
	{F_BASE64DECODE,
	 LTEXT("Base64Decode"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_UUDECODE,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // uudecodeして保存	//Oct. 17, 2000 jepro 説明を「選択部分をUUENCODEデコード」から変更
	...
	{F_SEARCH_CLEARMARK,
	 LTEXT("SearchClearMark"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //検索マークのクリア
	{F_JUMP_SRCHSTARTPOS,
	 LTEXT("SearchStartPos"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //検索開始位置へ戻る			// 02/06/26 ai
	...
	{F_TAGS_MAKE,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //タグファイルの作成	//@@@ 2003.04.13 MIK
	{F_DIRECT_TAGJUMP,
	 LTEXT("DirectTagJump"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //ダイレクトタグジャンプ機能	//@@@ 2003.04.15 MIK
	{F_TAGJUMP_KEYWORD,
	 LTEXT("KeywordTagJump"),
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //キーワードを指定してダイレクトタグジャンプ機能 //@@@ 2005.03.31 MIK
	{F_COMPARE, LTEXT("Compare"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL}, //ファイル内容比較
	{F_DIFF_DIALOG,
	 LTEXT("DiffDialog"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // DIFF差分表示(ダイアログ)	//@@@ 2002.05.25 MIK
	{F_DIFF,
	 LTEXT("Diff"),
	 {VT_BSTR, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // DIFF差分表示				//@@@ 2002.05.25 MIK	// 2005.10.03 maru
	{F_DIFF_NEXT,
	 LTEXT("DiffNext"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // DIFF差分表示(次へ)			//@@@ 2002.05.25 MIK
	{F_DIFF_PREV,
	 LTEXT("DiffPrev"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // DIFF差分表示(前へ)			//@@@ 2002.05.25 MIK
	{F_DIFF_RESET,
	 LTEXT("DiffReset"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // DIFF差分表示(全解除)		//@@@ 2002.05.25 MIK
	...
	{F_BOOKMARK_PATTERN,
	 LTEXT("BookmarkPattern"),
	 {VT_BSTR, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // 2002.01.16 hor 指定パターンに一致する行をマーク
	{F_FUNCLIST_NEXT,
	 LTEXT("FuncListNext"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	{F_CHG_CHARSET,
	 ...
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //文字コードセット指定		2010/6/14 Uchi
	{F_CHGMOD_EOL,
	 LTEXT("ChgmodEOL"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //入力改行コード指定 2003.06.23 Moca
	{F_CANCEL_MODE,
	 LTEXT("CancelMode"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	...
	/* マクロ系 */
	{F_EXECEXTMACRO,
	 LTEXT("ExecExternalMacro"),
	 {VT_BSTR, VT_BSTR, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //名前を指定してマクロ実行
	...
	{F_SHOWFUNCKEY,
	 ...
	 VT_EMPTY,
	 NULL}, /* ファンクションキーの表示 */
	{F_SHOWTAB, LTEXT("ShowTab"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	...
	{F_WRAPWINDOWWIDTH, LTEXT("WrapWindowWidth"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 現在のウィンドウ幅で折り返し */ // Oct. 7, 2000 JEPRO WRAPWINDIWWIDTH を WRAPWINDOWWIDTH に変更
	{F_FAVORITE, LTEXT("OptionFavorite"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 履歴の管理 */ //@@@ 2003.04.08 MIK
	{F_SET_QUOTESTRING, LTEXT("SetMsgQuoteStr"), {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 共通設定→書式→引用符の設定 */ // Jan. 29, 2005 genta
	{F_TEXTWRAPMETHOD, LTEXT("TextWrapMethod"), {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* テキストの折り返し方法 */ // 2008.05.30 nasukoji
	{F_SELECT_COUNT_MODE,
	...
	{F_SPLIT_V,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //上下に分割	//Sept. 17, 2000 jepro 説明の「縦」を「上下に」に変更
	{F_SPLIT_H,
	 LTEXT("SplitWinH"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //左右に分割	//Sept. 17, 2000 jepro 説明の「横」を「左右に」に変更
	{F_SPLIT_VH,
	 LTEXT("SplitWinVH"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //縦横に分割	//Sept. 17, 2000 jepro 説明に「に」を追加
	{F_WINCLOSE, LTEXT("WinClose"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL}, //ウィンドウを閉じる
	{F_WIN_CLOSEALL,
	 LTEXT("WinCloseAll"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //すべてのウィンドウを閉じる	//Oct. 17, 2000 JEPRO 名前を変更(F_FILECLOSEALL→F_WIN_CLOSEALL)
	...
	{F_TRACEOUT,
	 ...
	 {VT_BSTR, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //マクロ用アウトプットウィンドウに出力	2006.04.26 maru
	{F_TOPMOST, LTEXT("WindowTopMost"), {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL}, //常に手前に表示
	{F_GROUPCLOSE,
	 LTEXT("GroupClose"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //グループを閉じる	// 2007.06.20 ryoji
	{F_NEXTGROUP,
	 LTEXT("NextGroup"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //次のグループ	// 2007.06.20 ryoji
	{F_PREVGROUP,
	 LTEXT("PrevGroup"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //前のグループ	// 2007.06.20 ryoji
	{F_TAB_MOVERIGHT,
	 LTEXT("TabMoveRight"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //タブを右に移動	// 2007.06.20 ryoji
	{F_TAB_MOVELEFT,
	 LTEXT("TabMoveLeft"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //タブを左に移動	// 2007.06.20 ryoji
	{F_TAB_SEPARATE,
	 LTEXT("TabSeparate"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //新規グループ	// 2007.06.20 ryoji
	{F_TAB_JOINTNEXT,
	 LTEXT("TabJointNext"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //次のグループに移動	// 2007.06.20 ryoji
	{F_TAB_JOINTPREV,
	 LTEXT("TabJointPrev"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //前のグループに移動	// 2007.06.20 ryoji
	{F_TAB_CLOSEOTHER,
	 LTEXT("TabCloseOther"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //このタブ以外を閉じる	// 2010/3/14 Uchi
	{F_TAB_CLOSELEFT,
	 LTEXT("TabCloseLeft"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //左をすべて閉じる		// 2010/3/14 Uchi
	{F_TAB_CLOSERIGHT,
	 LTEXT("TabCloseRight"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //右をすべて閉じる		// 2010/3/14 Uchi

	/* 支援 */
	{F_HOKAN, LTEXT("Complete"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* 入力補完 */ // Oct. 15, 2000 JEPRO 入ってなかったので英名を付けて入れてみた
	{F_TOGGLE_KEY_SEARCH,
	 LTEXT("ToggleKeyHelpSearch"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, //キーワードヘルプ自動表示 2013.05.03
	{F_HELP_CONTENTS, LTEXT("HelpContents"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* ヘルプ目次 */ // Nov. 25, 2000 JEPRO 追加
	{F_HELP_SEARCH, LTEXT("HelpSearch"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	...
	{F_ABOUT, LTEXT("About"), {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_EMPTY, NULL},
	/* バージョン情報 */ // Dec. 24, 2000 JEPRO 追加
	...
	{F_COMMITUNDOBUFFER,
	 LTEXT("CommitUndoBuffer"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // OpeBlKコミット
	{F_ADDREFUNDOBUFFER,
	 LTEXT("AddRefUndoBuffer"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // OpeBlK AddRef
	{F_SETUNDOBUFFER,
	 ...
	 VT_EMPTY,
	 NULL}, // OpeBlK Release
	{F_APPENDUNDOBUFFERCURSOR,
	 L"AppendUndoBufferCursor",
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_EMPTY,
	 NULL}, // OpeBlK にカーソル位置を追加
...
MacroFuncInfo CSMacroMgr::m_MacroFuncInfoArr[] = {
	...
	{F_GETLINESTR,
	 ...
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_BSTR,
	 NULL}, // 指定論理行の取得 2003.06.01 Moca
	{F_GETLINECOUNT,
	 LTEXT("GetLineCount"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 全論理行数の取得 2003.06.01 Moca
	{F_CHGTABWIDTH,
	 LTEXT("ChangeTabWidth"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //タブサイズ変更 2004.03.16 zenryaku
	{F_ISTEXTSELECTED,
	 LTEXT("IsTextSelected"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //テキストが選択されているか 2005.7.30 maru
	{F_GETSELLINEFROM,
	 LTEXT("GetSelectLineFrom"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 選択開始行の取得 2005.7.30 maru
	{F_GETSELCOLUMNFROM,
	 LTEXT("GetSelectColmFrom"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 選択開始桁の取得 2005.7.30 maru
	{F_GETSELCOLUMNFROM,
	 LTEXT("GetSelectColumnFrom"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 選択開始桁の取得 2005.7.30 maru
	{F_GETSELLINETO,
	 LTEXT("GetSelectLineTo"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 選択終了行の取得 2005.7.30 maru
	{F_GETSELCOLUMNTO,
	 LTEXT("GetSelectColmTo"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 選択終了桁の取得 2005.7.30 maru
	{F_GETSELCOLUMNTO,
	 LTEXT("GetSelectColumnTo"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 選択終了桁の取得 2005.7.30 maru
	{F_ISINSMODE,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 挿入／上書きモードの取得 2005.7.30 maru
	{F_GETCHARCODE,
	 LTEXT("GetCharCode"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 文字コード取得 2005.07.31 maru
	{F_GETLINECODE,
	 LTEXT("GetLineCode"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 改行コード取得 2005.08.05 maru
	{F_ISPOSSIBLEUNDO,
	 LTEXT("IsPossibleUndo"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // Undo可能か調べる 2005.08.05 maru
	{F_ISPOSSIBLEREDO,
	 LTEXT("IsPossibleRedo"),
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // Redo可能か調べる 2005.08.05 maru
	{F_CHGWRAPCOLUMN,
	 LTEXT("ChangeWrapColm"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //折り返し桁変更 2008.06.19 ryoji
	{F_CHGWRAPCOLUMN,
	 LTEXT("ChangeWrapColumn"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //折り返し桁変更 2008.06.19 ryoji
	{F_ISCURTYPEEXT,
	 ...
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // 指定した拡張子が現在のタイプ別設定に含まれているかどうかを調べる 2006.09.04 ryoji
	{F_ISSAMETYPEEXT,
	 LTEXT("IsSameTypeExt"),
	 {VT_BSTR, VT_BSTR, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, // ２つの拡張子が同じタイプ別設定に含まれているかどうかを調べる 2006.09.04 ryoji
	...
	{F_ERRORMSG,
	 ...
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //メッセージボックス（エラー）の表示
	{F_WARNMSG,
	 LTEXT("WarnMsg"),
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //メッセージボックス（警告）の表示
	{F_INFOMSG,
	 LTEXT("InfoMsg"),
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //メッセージボックス（情報）の表示
	{F_OKCANCELBOX,
	 LTEXT("OkCancelBox"),
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //メッセージボックス（確認：OK／キャンセル）の表示
	{F_YESNOBOX,
	 LTEXT("YesNoBox"),
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //メッセージボックス（確認：はい／いいえ）の表示
	{F_COMPAREVERSION,
	 LTEXT("CompareVersion"),
	 {VT_BSTR, VT_BSTR, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL},																				//バージョン番号の比較
	{F_MACROSLEEP, LTEXT("Sleep"), {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY}, VT_I4, NULL}, //指定した時間（ミリ秒）停止
	{F_FILEOPENDIALOG,
	 LTEXT("FileOpenDialog"),
	 {VT_BSTR, VT_BSTR, VT_EMPTY, VT_EMPTY},
	 VT_BSTR,
	 NULL}, //ファイルを開くダイアログの表示
	{F_FILESAVEDIALOG,
	 LTEXT("FileSaveDialog"),
	 {VT_BSTR, VT_BSTR, VT_EMPTY, VT_EMPTY},
	 VT_BSTR,
	 NULL}, //ファイルを保存ダイアログの表示
	{F_FOLDERDIALOG,
	 LTEXT("FolderDialog"),
	 {VT_BSTR, VT_BSTR, VT_EMPTY, VT_EMPTY},
	 VT_BSTR,
	 NULL}, //フォルダを開くダイアログの表示
	{F_GETCLIPBOARD,
	 LTEXT("GetClipboard"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_BSTR,
	...
	{F_SETCLIPBOARD,
	 LTEXT("SetClipboard"),
	 {VT_I4, VT_BSTR, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //クリップボードに文字列を設定
	{F_LAYOUTTOLOGICLINENUM,
	 LTEXT("LayoutToLogicLineNum"),
	 {VT_I4, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //ロジック行番号取得
	{F_LOGICTOLAYOUTLINENUM,
	 LTEXT("LogicToLayoutLineNum"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //レイアウト行番号取得
	{F_LINECOLUMNTOINDEX,
	 LTEXT("LineColumnToIndex"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //ロジック桁番号取得
	{F_LINEINDEXTOCOLUMN,
	 LTEXT("LineIndexToColumn"),
	 {VT_I4, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //レイアウト桁番号取得
	{F_GETCOOKIE, LTEXT("GetCookie"), {VT_BSTR, VT_BSTR, VT_EMPTY, VT_EMPTY}, VT_BSTR, NULL}, // Cookie取得
	{F_GETCOOKIEDEFAULT,
	 LTEXT("GetCookieDefault"),
	 {VT_BSTR, VT_BSTR, VT_BSTR, VT_EMPTY},
	 VT_BSTR,
	 NULL}, // Cookie取得デフォルト値
	...
	{F_ISSHOWNSTATUS,
	 ...
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //ステータスバーが表示されているか
	{F_GETSTRWIDTH, LTEXT("GetStrWidth"), {VT_BSTR, VT_I4, VT_EMPTY, VT_EMPTY}, VT_I4, NULL}, //文字列幅取得
	{F_GETSTRLAYOUTLENGTH,
	 LTEXT("GetStrLayoutLength"),
	 {VT_BSTR, VT_I4, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //文字列のレイアウト幅取得
	{F_GETDEFAULTCHARLENGTH,
	 L"GetDefaultCharLength",
	 {VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //デフォルト文字幅の取得
	{F_ISINCLUDECLIPBOARDFORMAT,
	 L"IsIncludeClipboardFormat",
	 {VT_BSTR, VT_EMPTY, VT_EMPTY, VT_EMPTY},
	 VT_I4,
	 NULL}, //クリップボードの形式取得
	{F_GETCLIPBOARDBYFORMAT,
	 L"GetClipboardByFormat",
	 {VT_BSTR, VT_I4, VT_I4, VT_EMPTY},
	 VT_BSTR,
	 NULL}, //クリップボードの指定形式で取得
	{F_SETCLIPBOARDBYFORMAT,
	 L"SetClipboardByFormat",
	 {
		 VT_BSTR,
		 VT_BSTR,
		 VT_I4,
...
BOOL CSMacroMgr::Load(int idx, HINSTANCE hInstance, const WCHAR *pszPath, const WCHAR *pszType)
{
	...
	if (ppMacro == NULL) { DEBUG_TRACE(L"CSMacroMgr::Load() Out of range: idx=%d Path=%s\n", idx, pszPath); }
...
BOOL CSMacroMgr::Save(int idx, HINSTANCE hInstance, const WCHAR *pszPath)
{
	...
	{
		CKeyMacroMgr *pKeyMacro = dynamic_cast<CKeyMacroMgr *>(m_pKeyMacro);
		if (pKeyMacro != NULL) { return pKeyMacro->SaveKeyMacro(hInstance, pszPath); }
		//	Jun. 27, 2002 genta
		//	空マクロの場合は正常終了と見なす．
		if (m_pKeyMacro == NULL) { return TRUE; }
	}
...
const MacroFuncInfo *CSMacroMgr::GetFuncInfoByID(int nFuncID)
{
	...
	{
		if (m_MacroFuncInfoCommandArr[i].m_nFuncID == nFuncID) { return &m_MacroFuncInfoCommandArr[i]; }
	}
	for (i = 0; m_MacroFuncInfoArr[i].m_pszFuncName != NULL; ++i)
	{
		if (m_MacroFuncInfoArr[i].m_nFuncID == nFuncID) { return &m_MacroFuncInfoArr[i]; }
	}
	return NULL;
}
...
)
{
	...
	if (MacroInfo != NULL)
	{
		...
		if (pszFuncNameJapanese != NULL) { wcsncpy(pszFuncNameJapanese, LS(nFuncID), 255); }
		return pszFuncName;
	}
	return NULL;
}
...
BOOL CSMacroMgr::CanFuncIsKeyMacro(int nFuncID)
{
	switch (nFuncID)
	{
		...
		//	case F_FILECLOSE				://閉じて(無題)	//Oct. 17, 2000 jepro
		//「ファイルを閉じる」というキャプションを変更 	case F_FILECLOSE_OPEN			://閉じて開く
	...
	case F_COPYTAG:			  //このファイルのパス名とカーソル位置をコピー	//Sept. 15, 2000 jepro
							  //上と同じ説明になっていたのを修正
	...
	case F_CODECNV_SJIS2UTF7:								/* SJIS→UTF-7コード変換 */
		...
		//	case F_UUDECODE		 			://uudecodeして保存	//Oct. 17, 2000 jepro
	...
	case F_TOPMOST:	//常に手前に表示
		...
		/* 支援 */
		//  case F_HOKAN					:/* 入力補完 */				//Oct. 15, 2000 JEPRO
		//  入ってなかったので入れてみた
...
/*!
	...
	@retval false 保存不可
*/
bool CSMacroMgr::IsSaveOk(void) { return dynamic_cast<CKeyMacroMgr *>(m_pKeyMacro) == NULL ? false : true; }
