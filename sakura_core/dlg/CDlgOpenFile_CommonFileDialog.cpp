...
static const DWORD p_helpids[] = { //13100
    ...
    IDC_COMBO_CODE,
    HIDC_OPENDLG_COMBO_CODE, //文字コードセット
    IDC_COMBO_MRU,
    HIDC_OPENDLG_COMBO_MRU, //最近のファイル
    IDC_COMBO_OPENFOLDER,
    HIDC_OPENDLG_COMBO_OPENFOLDER, //最近のフォルダ
    IDC_COMBO_EOL,
    HIDC_OPENDLG_COMBO_EOL, //改行コード
    IDC_CHECK_BOM,
    HIDC_OPENDLG_CHECK_BOM, //BOM	// 2006.08.06 ryoji
    IDC_CHECK_CP,
    HIDC_OPENDLG_CHECK_CP, //CP
    //	IDC_STATIC,				-1,
    0,
    0};
...
struct CDlgOpenFile_CommonFileDialog final : public IDlgOpenFile
{
    ...
    void Create(
        ...
        const std::vector<LPCWSTR> &vOPENFOLDER) override;
    ...
    bool bOptions)
{
    ...
    if (pData->m_bViewMode)
        pData->m_ofn.Flags |= OFN_READONLY;
    if (bMultiSelect)
    {
...
void CDlgOpenFile_CommonFileDialog::DlgOpenFail(void)
{
    ...
    switch (dwError)
    {
        case CDERR_DIALOGFAILURE:
            pszError = L"CDERR_DIALOGFAILURE  ";
            break;
        case CDERR_FINDRESFAILURE:
            pszError = L"CDERR_FINDRESFAILURE ";
            break;
        case CDERR_NOHINSTANCE:
            pszError = L"CDERR_NOHINSTANCE    ";
            break;
        case CDERR_INITIALIZATION:
            pszError = L"CDERR_INITIALIZATION ";
            break;
        case CDERR_NOHOOK:
            pszError = L"CDERR_NOHOOK         ";
            break;
        case CDERR_LOCKRESFAILURE:
            pszError = L"CDERR_LOCKRESFAILURE ";
            break;
        case CDERR_NOTEMPLATE:
            pszError = L"CDERR_NOTEMPLATE     ";
            break;
        case CDERR_LOADRESFAILURE:
            pszError = L"CDERR_LOADRESFAILURE ";
            break;
        case CDERR_STRUCTSIZE:
            pszError = L"CDERR_STRUCTSIZE     ";
            break;
        case CDERR_LOADSTRFAILURE:
            pszError = L"CDERR_LOADSTRFAILURE ";
            break;
        case FNERR_BUFFERTOOSMALL:
            pszError = L"FNERR_BUFFERTOOSMALL ";
            break;
        case CDERR_MEMALLOCFAILURE:
            pszError = L"CDERR_MEMALLOCFAILURE";
            break;
        case FNERR_INVALIDFILENAME:
            pszError = L"FNERR_INVALIDFILENAME";
            break;
        case CDERR_MEMLOCKFAILURE:
            pszError = L"CDERR_MEMLOCKFAILURE ";
            break;
        case FNERR_SUBCLASSFAILURE:
            pszError = L"FNERR_SUBCLASSFAILURE";
            break;
        default:
            pszError = L"UNKNOWN_ERRORCODE";
            break;
    }
