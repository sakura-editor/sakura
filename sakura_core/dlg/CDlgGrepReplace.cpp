...
const DWORD p_helpids[] = {IDC_BUTTON_FOLDER, HIDC_GREP_REP_BUTTON_FOLDER,				 //フォルダ
...
int CDlgGrepReplace::GetData(void)
{
	...
	if (!CDlgGrep::GetData()) { return FALSE; }
...
LPVOID CDlgGrepReplace::GetHelpIdTable(void) { return (LPVOID)p_helpids; }
