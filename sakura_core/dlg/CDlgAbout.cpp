...
#if defined(APPVEYOR_URL) && defined(APPVEYOR_REPO_NAME) && defined(APPVEYOR_BUILD_VERSION)
#define APPVEYOR_BUILD_URL	APPVEYOR_URL "/project/" APPVEYOR_REPO_NAME "/build/" APPVEYOR_BUILD_VERSION
#endif
