...
class CDialog
{
  public:
	...
	*/
    ...
    virtual BOOL OnEnKillFocus(HWND hwndCtl, int wID)
    {
        return FALSE;
    }
    ...
    virtual BOOL OnCbnSelChange(HWND hwndCtl, int wID)
    {
        return FALSE;
    }
    virtual BOOL OnCbnEditChange(HWND hwndCtl, int wID)
    {
        return FALSE;
    } // @@2005.03.31 MIK タグジャンプDialog
    ...
    virtual int OnVKeyToItem(WPARAM wParam, LPARAM lParam)
    {
        return -1;
    }
