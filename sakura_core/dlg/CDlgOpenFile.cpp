...
void CDlgOpenFile::Create(HINSTANCE hInstance, HWND hwndParent, const WCHAR *pszUserWildCard,
...
inline bool CDlgOpenFile::DoModal_GetOpenFileName(WCHAR *pszPath, EFilter eAddFileter)
{
	return m_pImpl->DoModal_GetOpenFileName(pszPath, eAddFileter);
}

inline bool CDlgOpenFile::DoModal_GetSaveFileName(WCHAR *pszPath) { return m_pImpl->DoModal_GetSaveFileName(pszPath); }

inline bool CDlgOpenFile::DoModalOpenDlg(SLoadInfo *pLoadInfo, std::vector<std::wstring> *pFilenames, bool bOptions)
{
	return m_pImpl->DoModalOpenDlg(pLoadInfo, pFilenames, bOptions);
}

inline bool CDlgOpenFile::DoModalSaveDlg(SSaveInfo *pSaveInfo, bool bSimpleMode)
{
...
*/
BOOL CDlgOpenFile::SelectFile(HWND parent, HWND hwndCtl, const WCHAR *filter, bool resolvePath, EFilter eAddFilter)
{
	CDlgOpenFile cDlgOpenFile;
