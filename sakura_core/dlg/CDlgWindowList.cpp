...
const DWORD p_helpids[] = {
    IDC_LIST_WINDOW, HIDC_WINLIST_LIST_WINDOW, IDC_BUTTON_SAVE, HIDC_WINLIST_BUTTTN_SAVE, IDC_BUTTON_CLOSE, HIDC_WINLIST_BUTTTN_CLOSE, IDOK, HIDC_WINLIST_IDOK, 0, 0};
