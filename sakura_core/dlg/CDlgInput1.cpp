...
static const DWORD p_helpids[] = { // 13000
	IDOK, HIDOK_DLG1, IDCANCEL, HIDCANCEL_DLG1, IDC_EDIT_INPUT1,
	HIDC_DLG1_EDIT1,				 //入力フィールド	IDC_EDIT1->IDC_EDIT_INPUT1	2008/7/3 Uchi
...
/* モードレスダイアログの表示 */
BOOL CDlgInput1::DoModal(HINSTANCE hInstApp, HWND hwndParent, const WCHAR *pszTitle, const WCHAR *pszMessage,
						 int nMaxTextLen, WCHAR *pszText)
{
	...
	bRet = (BOOL)::DialogBoxParam(CSelectLang::getLangRsrcInstance(), MAKEINTRESOURCE(IDD_INPUT1), m_hwndParent,
								  CDlgInput1Proc, (LPARAM)this);
