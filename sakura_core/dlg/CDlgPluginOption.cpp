...
const DWORD p_helpids[] = {
    ...
    IDC_EDIT_PLUGIN_OPTION,
    HIDC_EDIT_PLUGIN_OPTION, // オプション編集
    IDC_EDIT_PLUGIN_OPTION_DIR,
    HIDC_EDIT_PLUGIN_OPTION, // オプション編集
    IDC_BUTTON_PLUGIN_OPTION_DIR,
    HIDC_EDIT_PLUGIN_OPTION, // オプション編集
    IDC_EDIT_PLUGIN_OPTION_NUM,
    HIDC_EDIT_PLUGIN_OPTION, // オプション編集
    IDC_SPIN_PLUGIN_OPTION,
    HIDC_EDIT_PLUGIN_OPTION, // オプション編集
    IDC_CHECK_PLUGIN_OPTION,
    HIDC_EDIT_PLUGIN_OPTION, // オプション編集
    IDC_COMBO_PLUGIN_OPTION,
    HIDC_EDIT_PLUGIN_OPTION, // オプション編集
    IDOK,
    HIDC_FAVORITE_IDOK, //OK
    IDCANCEL,
    HIDC_FAVORITE_IDCANCEL, //キャンセル
    IDC_PLUGIN_README,
    HIDC_PLUGIN_README, //ReadMe
    IDC_BUTTON_HELP,
