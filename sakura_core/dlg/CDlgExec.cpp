...
const DWORD p_helpids[] = { //12100
    IDC_BUTTON_REFERENCE,
    HIDC_EXEC_BUTTON_REFERENCE, //参照
    IDOK,
    HIDOK_EXEC, //実行
    IDCANCEL,
    HIDCANCEL_EXEC, //キャンセル
    IDC_BUTTON_HELP,
    HIDC_EXEC_BUTTON_HELP, //ヘルプ
    IDC_CHECK_GETSTDOUT,
    HIDC_EXEC_CHECK_GETSTDOUT, //標準出力を得る
    IDC_COMBO_CODE_GET,
    HIDC_COMBO_CODE_GET, //標準出力文字コード
    IDC_COMBO_m_szCommand,
    HIDC_EXEC_COMBO_m_szCommand, //コマンド
    IDC_RADIO_OUTPUT,
    HIDC_RADIO_OUTPUT, //標準出力リダイレクト先：アウトプットウィンドウ
    IDC_RADIO_EDITWINDOW,
    HIDC_RADIO_EDITWINDOW, //標準出力リダイレクト先：編集中のウィンドウ
    IDC_CHECK_SENDSTDIN,
    HIDC_CHECK_SENDSTDIN, //標準入力に送る
    IDC_COMBO_CODE_SEND,
    HIDC_COMBO_CODE_SEND, //標準出力文字コード
    IDC_CHECK_CUR_DIR,
    HIDC_CHECK_CUR_DIR, //カレントディレクトリ
    IDC_COMBO_CUR_DIR,
    HIDC_COMBO_CUR_DIR, //カレントディレクトリ指定
    IDC_BUTTON_REFERENCE2,
    HIDC_COMBO_CUR_DIR, //カレントディレクトリ指定(参照)
    //	IDC_STATIC,						-1,
    0,
