...
public:
	...
	static bool IsCppRawString(const CStringRefW& cStr, int nPos);
	static int Match_Quote( wchar_t wcQuote, int nPos, const CStringRefW& cLineStr, int escapeType, bool* pbEscapeEnd = NULL );
	static int Match_QuoteStr( const wchar_t* szQuote, int nQuoteLen, int nPos, const CStringRefW& cLineStr, bool bEscape );
private:
