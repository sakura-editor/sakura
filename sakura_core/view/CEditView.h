...
public:
	...
	bool GetSelectedData( CNativeW& cmemBuf, std::wstring_view quoteMark, BOOL bWithLineNumber, bool bAddCRLFWhenCopy, EEolType neweol = EEolType::auto_detect);/* 選択範囲のデータを取得 */
