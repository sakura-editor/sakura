...
public:
	//主要構成部品アクセス
	CTextArea& GetTextArea(){ return *m_pcTextArea; }
	const CTextArea& GetTextArea() const{ return *m_pcTextArea; }
	CCaret& GetCaret(){ return *m_pcCaret; }
	const CCaret& GetCaret() const{ return *m_pcCaret; }
	CRuler& GetRuler(){ return *m_pcRuler; }
	const CRuler& GetRuler() const{ return *m_pcRuler; }
	...
	//主要オブジェクトアクセス
	CViewFont& GetFontset(){ return *m_pcViewFont; }
	const CViewFont& GetFontset() const{ return *m_pcViewFont; }
