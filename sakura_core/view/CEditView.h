...
public:
	...
	bool GetSelectedData( CNativeW& cmemBuf, std::wstring_view quoteMark, bool bWithLineNumber, bool bInsertEolAtWrap, EEolType neweol = EEolType::auto_detect);/* 選択範囲のデータを取得 */
