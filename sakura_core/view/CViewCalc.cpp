...
//外部依存
CLayoutInt CViewCalc::GetTabSpace() const { return m_pOwner->m_pcEditDoc->m_cLayoutMgr.GetTabSpace(); }

CTsvModeInfo &CViewCalc::GetTsvMode() const { return m_pOwner->m_pcEditDoc->m_cLayoutMgr.m_tsvInfo; }

CPixelXInt CViewCalc::GetCharSpacing() const { return m_pOwner->m_pcEditDoc->m_cLayoutMgr.GetCharSpacing(); }
