...
public:
	...
	void SetStringW2(const wchar_t* pszData)				{ return SetStringNew(pszData); }
	void SetStringW2(const wchar_t* pData, int nLength)		{ return SetStringNew(pData,nLength); }
	void AppendStringW2(const wchar_t* pszData)				{ return AppendStringNew(pszData); }
	void AppendStringW2(const wchar_t* pData, int nLength)	{ return AppendStringNew(pData,nLength); }
	const wchar_t* GetStringW2() const;
