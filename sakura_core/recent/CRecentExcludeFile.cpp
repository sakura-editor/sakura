...
CRecentExcludeFile::CRecentExcludeFile(std::shared_ptr<ShareDataAccessor> ShareDataAccessor_)
	: CRecentImp<CExcludeFileString, LPCWSTR>(std::move(ShareDataAccessor_))
{
	Create(
