...
void CType_Pascal::InitTypeConfigImp(STypeConfig *pType)
{
	...
	pType->m_cBlockComments[0].SetBlockCommentRule(L"{", L"}"); /* ブロックコメントデリミタ */ // Nov. 5, 2000 JEPRO
																							   // 追加
	pType->m_cBlockComments[1].SetBlockCommentRule(L"(*", L"*)");
		/* ブロックコメントデリミタ2 */ //@@@ 2001.03.10 by MIK
...
const wchar_t *g_ppszKeywordsPASCAL[] = {L"and",
										 L"exports",
										 L"mod",
										 L"shr",
										 L"array",
