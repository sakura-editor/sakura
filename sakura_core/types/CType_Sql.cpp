...
//						szWord[nWordIdx + 1] = '\0';
					...
					else if( 0 == nParseCnt && 0 == wcsicmp_literal( szWord, L"PROCEDURE" ) ){
						nFuncOrProc = 2;
						nParseCnt = 1;
						nFuncLine = nLineCount + CLogicInt(1);
					}
					else if( 0 == nParseCnt && 0 == wcsicmp_literal( szWord, L"PACKAGE" ) ){
						nFuncOrProc = 3;
						nParseCnt = 1;
						nFuncLine = nLineCount + CLogicInt(1);
					}
					else if( 1 == nParseCnt && 3 == nFuncOrProc && 0 == wcsicmp_literal( szWord, L"BODY" ) ){
						nFuncOrProc = 4;
						nParseCnt = 1;
					}
					else if( 1 == nParseCnt ){
...
//						if( 3 == nFuncOrProc ){
					...
					if( 2 == nParseCnt ){
						if( 0 == wcsicmp_literal( szWord, L"IS" ) ){
							if( 1 == nFuncOrProc ){
						...
						if( 0 == wcsicmp_literal( szWord, L"AS" ) ){
							if( 3 == nFuncOrProc ){
								nFuncId = 31;	/* パッケージ仕様部 */
								++nFuncNum;
								/*
