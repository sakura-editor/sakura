...
class CSubject
{
  public:
    ...
    {
        return (int)m_vListenersRef.size();
    }
    CListener *GetListener(int nIndex) const
    {
        return m_vListenersRef[nIndex];
    }
...
class CListener
{
  public:
    ...
    CSubject *GetListeningSubject() const
    {
        return m_pcSubjectRef;
    }
