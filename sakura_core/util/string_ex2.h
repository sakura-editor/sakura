...
SAKURA_CORE_API int LimitStringLengthW2( const WCHAR*, int, int, CNativeW2& );/* データを指定「文字数」以内に切り詰める */
...
SAKURA_CORE_API const wchar_t* GetNextLineW2 ( const wchar_t*, int, int*, int*, CEOL* ); // GetNextLineのwchar_t版
